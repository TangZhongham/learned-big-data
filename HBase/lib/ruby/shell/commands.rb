  ...
  module Commands
    class Command
      ...
      def hyperbase_table(name)
        @shell.hyperbase_table(name)
      end

      def local_index_table(name)
        @shell.hbase_local_index_table(name)
      end
      ...
      def hyperbase_admin
        @shell.hyperbase_admin
      end

      def index_rebuilder
        @shell.index_rebuilder
      end
