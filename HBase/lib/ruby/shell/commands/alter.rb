...
You can also alert a columnFamily-scope attribute, for example:

columnFamily-scope add a metadata attribute
  hbase> alter 't1', {NAME => 'f',METADATA=>{'flushsize','67108864'}}
columnFamily-scope remove a metadata attribute
  hbase> alter 't1', {NAME => 'f',METADATA=>{'flushsize',''}}

You can also add a locl index, for example:
  hbase> alter 't1', {NAME => 'if1',LOCAL_INDEX=>'COMBINE_INDEX|INDEXED=f1:q1:8|rowKey:rowKey:10,UPDATE=true'}
